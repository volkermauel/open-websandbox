...
- **Packaging** — a **Helm chart** (`agent-sandbox-platform/chart/`) is the deployment
...
New: `tests/`, `docs/`, `.github/workflows/`, `agent-sandbox-platform/chart/`, `CHANGELOG.md`.
No change to running behavior. The gVisor/runc toggle is a Helm value
(`sandboxTemplate.runtimeClassName`). Project identity renamed to **open-sandbox**.
